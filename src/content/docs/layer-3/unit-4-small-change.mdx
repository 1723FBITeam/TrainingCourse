---
title: "Unit 4: Make a Small Change"
...
This is your first real edit to the robot codebase. It's small on purpose — the goal is to build the muscle memory of the safe contribution workflow you learned in Lesson 6.

:::tip[What You Need]
- **WPILib VS Code** with the robot project open
- The project building successfully (you verified this in Unit 1)
- Git configured on your machine (from Lesson 0)
:::
...
Scroll through Constants.java and look at the inner classes. Remember from Lesson 6: **CAN IDs are off-limits** (they match physical wiring), but **behavior values** like speeds, limits, and thresholds are safe to experiment with.
...
Run through the self-review checklist from Lesson 6:
...
Ready for something bigger? In **Unit 5: Add a Simple Feature**, you'll create a brand new command that interacts with an existing subsystem. Same safe workflow, just a few more lines of code.
