---
title: "Unit 5: Add a Simple Feature"
...
:::tip[What You Need]
- **WPILib VS Code** with the robot project open and building (verified in Unit 1)
- Git configured and a working branch (you practiced this in Unit 4)
- Familiarity with commands and subsystems (Lessons 3–5)
:::
...
- It follows the exact same pattern as AutoShootCommand (which you studied in Lesson 4)
...
Just like Unit 4, start with a clean branch:
...
You've completed all three layers of the course. Head to the **Deliverables** section to finish your Code Map, Trace Worksheet, Glossary, and Code Reading Checklist. These are your reference materials for the rest of the season.
