...
| Field | Type | Purpose |
|-------|------|---------|
| `repoUrl` | `string` | Full GitHub URL to the robot repo (e.g., `https://github.com/your-org/2026code`). Used by the `GitHubLink` component to build clickable links to source files. |
...
```
training-course/src/content/docs/layer-1/lesson-1-project-structure.mdx
training-course/src/content/docs/layer-1/lesson-2-robot-lifecycle.mdx
training-course/src/content/docs/layer-2/lesson-3-subsystems.mdx
training-course/src/content/docs/layer-2/lesson-4-commands.mdx
training-course/src/content/docs/layer-2/lesson-5-robotcontainer.mdx
training-course/src/content/docs/layer-3/lesson-6-constants-safe-edits.mdx
```
...
The trace exercises (Units 2, 3, and 6) and the Trace Worksheet deliverable walk through specific execution paths in the robot code. These reference particular methods, line numbers, and call sequences that will change with a new robot:

```
training-course/src/content/docs/layer-2/unit-2-trace-button.mdx
training-course/src/content/docs/layer-2/unit-3-trace-sensor.mdx
training-course/src/content/docs/layer-2/unit-6-autonomous.mdx
...
- [ ] Reviewed and updated `CodeTrace` steps in Units 2, 3, and 6
