---
title: "Lesson 0.1: Git & GitHub Fundamentals"
...
This lesson is recommended before Lesson 1.1, but it is **not** a hard requirement. If you already use Git and GitHub comfortably, feel free to skim the checkpoints and move on. If Git is new to you, work through every section — it will make the rest of the course much smoother.
:::
